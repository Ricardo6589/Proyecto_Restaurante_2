...
if (isset($_POST)) {
    ...
    if (empty($personal_usuario)||empty($nombre_usuario)||empty($apellido_usuario)||empty($email_usuario)||empty($password_usuario)||empty($telefono_usuario)||empty($dni_usuario)||empty($img_usuario)) {
        echo"Campo_vacio";        
    }elseif(){
